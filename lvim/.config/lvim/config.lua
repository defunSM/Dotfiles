...
-- harpoon keybindings | Git Repo: ThePrimeagen/harpoon 
...
lvim.lsp.buffer_mappings.normal_mode["H"] = {
  "<CR>lua require('harpoon.mark').add_file()<CR>", "Mark file"
}
...
-- vim.builtin.theme.options.dim_inactive = true
